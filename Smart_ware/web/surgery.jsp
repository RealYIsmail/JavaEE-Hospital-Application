                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="info-box bg-white">
                                    ...
                                    <div class="info-box-content">
                                        <span class="info-box-text">New Surgery's today</span>
                                        <span class="info-box-number">3</span>                             <!-- add Surgery variable here-->
                                        <div class="progress">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card  card-box">
                                    <div class="card-head">
                                        <header>Operation's today</header>
                                        <div class="tools">
                                        ...
                                        <table border = "1" width = "100%">
                                           ...
                                           <c:forEach var = "row" items = "${result.rows}">
                                              <tr>
                                                 ...
                                                 <td><c:out value = "${row.OperationDate}"/></td>
                                                 <td><c:out value = "${row.OperationTime}"/></td>
                                                <td><c:out value = "${row.NSlot}"/></td>
                                                <td><c:out value = "${row.Invoice}"/></td>
                                              </tr>
                                           </c:forEach>
                                        </table>
                                        </div>
