                                ...
                                <div class="card card-box">
                                    <div class="card-head">
                                        ...
                                        <ul class = "mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect"
                                            ...
                                            <li class = "mdl-menu__item"><i class="material-icons">favourite</i>Something else here</li>
                                        </ul>
                                    </div>
                                    <div class="card-body" id="bar-parent">
                                        <form action ="adminadddoc" method="post">
                                        <table>
                                            <tr> <td> fullname </td><td><input type="text" name="employeename"></td></tr>
                                            <tr> <td> employeeaddress </td><td><input type="text" name="employeeaddress"></td></tr>
                                             <tr> <td> Date of Birth </td><td><input type="text" name="EmployeeDOB"></td></tr>
