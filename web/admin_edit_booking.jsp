                    ...
                    <div class="page-content">
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                <div class=" pull-left">
                                    <div class="page-title">Remove Booking</div>
                                </div>
                                <ol class="breadcrumb page-breadcrumb pull-right">
                                    ...
                                    <li class="active">Remove Booking</li>
                                </ol>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <div class="card card-box">
                                    ...
                                    <div class="card-body" id="bar-parent">
                                            ...
                                            <div class="form-body">
                                                <div class="card-body" id="bar-parent">
                                        <form action ="DelBs" method="post">
                                        <table>
                                            <tr> <td> SlotID </td><td><input type="number" name="Slot"></td></tr>
