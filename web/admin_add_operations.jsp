                    ...
                    <div class="page-content">
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                <div class=" pull-left">
                                    <div class="page-title">Add Operations</div>
                                </div>
                                <ol class="breadcrumb page-breadcrumb pull-right">
                                    ...
                                    <li class="active">Add Operations</li>
                                </ol>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <div class="card card-box">
                                    ...
                                    <div class="card-body" id="bar-parent">
                                        <form action ="OpOp" method="post">
                                            <div class="form-group row">
                                                <label class="control-label col-md-3">PatientID
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-5">
                                                    <input type="number" name="Patient" data-required="1" placeholder="enter the PatientID" class="form-control input-height" /> </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                <label class="control-label col-md-3"> NSLOT
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-5">
                                                    <input  type="number" name="Slot" data-required="1" class="form-control input-height" /> </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input  type="float" name="Charge" data-required="1" class="form-control input-height" /> </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="control-label col-md-3">Extra Detail
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-5">
                                                    <input  type="text" name="note" data-required="1" class="form-control input-height" /> </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="control-label col-md-3">Operation Date
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-5">
                                                    <div class="input-group date form_date " data-date="" data-date-format="yy mm dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                                                        <input class="form-control input-height" size="16" placeholder="date of appointment" name ="Dateofappointment" type="date" value="23/04/2021">
                                            ...
                                            <div class="form-group row">
                                                <label class="control-label col-md-3">Operation Time</label>
                                                <div class="col-md-5">
                                                    <div class="row">
                                                        <div class="col-md-5">
