                                                        ...
                                                        <div class="card-body ">
                                                            <div class="table-scrollable">
                                                             <table border = "1" width = "100%">
                                                                 <% 
                                                                String details = (String) request.getAttribute("showdoctor") ;
                                                                out.println("employeeID -- employeeName -- employeeAddress -- EmployeeDOB -- Username  <br/>") ;
                                                                out.println(details);
                                                               %>
                                                                
                                                                <h3></h3>
                                                                <ol style="list-style-type: none">
                                                                    <c:forEach items="${requestScope.details}" var="userAccount">
                                                                        <c:if test="${userAccount.active}">
                                                                            <li>${userAccount.OID} ${userAccount.EmployeeID}</li>
                                                                        </c:if>
                                                                        <c:if test="${!userAccount.active}">
                                                                            <li>${userAccount.OID} ${userAccount.EmployeeID} [INACTIVE]</li>
                                                                        </c:if>
                                                                    </c:forEach>
                                                                </ol>
