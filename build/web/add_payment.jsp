                    ...
                    <div class="sidemenu-container navbar-collapse collapse fixed-menu">
                        <div id="remove-scroll" class="left-sidemenu">
                            <ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                                ...
                                <li class="nav-item  ">
                                    <a href="patient_dashboard.jsp" class="nav-link nav-toggle"> <i class="material-icons">accessible</i>
                                        <span class="title">Patient Dashboard / Book Appointment</span> 
                                    </a>
                                </li>
                                <li class="nav-item  ">
                        ...
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                ...
                                <ol class="breadcrumb page-breadcrumb pull-right">
                                    <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="employee_dashboard.jsp">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
                                    </li>
