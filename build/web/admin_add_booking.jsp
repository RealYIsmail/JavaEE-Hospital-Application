                    ...
                    <div class="page-content">
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                <div class=" pull-left">
                                    <div class="page-title">Add Booking slot</div>
                                </div>
                                <ol class="breadcrumb page-breadcrumb pull-right">
                                    <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="admin_dashboard.jsp">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
                                    </li>
                                    <li><a class="parent-item" href="#">Booking Slots</a>&nbsp;<i class="fa fa-angle-right"></i>
                                    </li>
                                    <li class="active">Add Booking slots</li>
                                </ol>
                            </div>
                        </div>
                        <div class="row">
                                    ...
                                    <div class="card-body" id="bar-parent">
                                        <form action ="addBooking" method="post">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input  type="text" name="note" data-required="1" placeholder="Enter Extra detail" class="form-control input-height" /> </div>
                                            </div>
                                            <div class="form-group row">
