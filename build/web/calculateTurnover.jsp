                    ...
                    <ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                        ...
                        <li class="nav-item  ">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item  ">
                                    <a href="viewturnover" class="nav-link "> <span class="title">Invoice</span>
                                    </a>
                                </li>
                                <li class="nav-item  ">
            ...
            <div class="page-content">
                <div class="page-bar">
                    <div class="page-title-breadcrumb">
                        <div class=" pull-left">
                            <div class="page-title">Calculating Invoices</div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="card card-box">
                            <div class="card-head">
                                <header>Date-by-date Invoice Turnover</header>
                            ...
                            <div class="card-body" id="bar-parent">
                                <form action ="Calcturn" method="post">
                                    <div class="form-group row">
                                        <label class="control-label col-md-3">Start Date
                                            <span class="required"> * </span>
                                        </label>
                                        <div class="col-md-5">
                                            <input type="text" name="Start" data-required="1" placeholder="enter the start date. Format yyyy-mm-dd"  class="form-control input-height" />
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" name="End" data-required="1" placeholder="enter the end date. Format yyyy-mm-dd" class="form-control input-height" />
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                ...
                                <%
                                String details = (String) request.getAttribute("showturnover") ;
                                out.println("Sum = ") ;
                                out.println(details);
                                %>
