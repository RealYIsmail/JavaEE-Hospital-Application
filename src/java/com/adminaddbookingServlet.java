...
public class adminaddbookingServlet extends HttpServlet {
   ...
   int PatientID;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String BookingNote = request.getParameter("note");
        ...
        newslot.setBookingNote(BookingNote);
        newslot.setEmployeeID(EmployeeID);
        newslot.setPatientID(PatientID);
       
        
        
        //////////////////////////   Call JDBC method are redirect  ///////////////////////////
        UserDao NewbookingSlot = new UserDao();
        String result = NewbookingSlot.addnewslot(newslot);
