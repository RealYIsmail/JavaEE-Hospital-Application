...
public class adminadduserServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String roles = request.getParameter("roles");
         ...
         //////////////////Set the variables ////////////////////
        UserBean newreg = new UserBean();
        newreg.setUsername(username);
        newreg.setPassword(password);
        newreg.setRoles(roles);
        
        
         ///////////////////Sent the the JDBC and send a redirect so that it stays on the same webpage///////////////////
        UserDao register = new UserDao();
        String result = register.addnewreg(newreg);
        response.getWriter().print(result);
        response.sendRedirect("admin_add_user.jsp");
        response.getWriter().print(result);
    }
