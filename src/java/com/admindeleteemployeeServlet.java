...
public class admindeleteemployeeServlet extends HttpServlet {
   int EmployeeID;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //////////////////Set the variables ////////////////////
        UserBean delemployee = new UserBean();
        delemployee.setEmployeeID(EmployeeID);
        ...
        String result = Removeuser.DeleteEmployee(delemployee);
        response.getWriter().print(result);
        response.sendRedirect("admin_edit_doctor.jsp");
        response.getWriter().print(result);
    }
