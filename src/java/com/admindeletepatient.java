...
public class admindeletepatient extends HttpServlet {
   int PatientID;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //////////////////Set the variables ////////////////////
        UserBean delpatient = new UserBean();
        delpatient.setPatientID(PatientID);
        ...
        String result = Removeuser.DeletePatient(delpatient);
        response.getWriter().print(result);
        response.sendRedirect("admin_remove_patient.jsp");
        response.getWriter().print(result);
    }
