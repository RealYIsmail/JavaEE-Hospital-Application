...
public class showsurgerymodel {
  ...
  public String doQuery(String query) {
    ...
    try {
      ...
      while (rs.next()) {
        sb.append(rs.getString(1) + " -- " + rs.getString(2) + " -- " + rs.getString(3) + " -- " + rs.getString(4) + " -- " + rs.getString(5) + " -- " + rs.getString(6) + " -- " + rs.getString(7) + " -- " + rs.getString(8)) ;
        sb.append("\n<br>");
